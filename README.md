...
■ 在庫データの整合性
 ...
 - 総評的に難しかったですが、Figmaを使ったUI構築を知るための、実際の個人開発に呈した「フロントエンドの習得は１年間」になりますが、
 - その内訳は、基礎フロント：４か月、Next.jsは４か月間（模擬案件期間も含む）⇒その後、復習１か月＋Reactは３か月間（本アプリ開発）の理解度を含めたお陰で、
 - アプリが出来た瞬間は、大変良かったと思います。
